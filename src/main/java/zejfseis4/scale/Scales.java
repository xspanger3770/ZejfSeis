...
public class Scales {
	...
	public static final ScaleRange MAG = new ScaleRange("scale1.png", 0, 10);

	public static final ScaleRange DEPTH = new ScaleRange("scale1.png", 26, -10) {
		public java.awt.Color getColor(double value) {
			return super.getColor(Math.sqrt(Math.abs(value)));
		};
	};

	public static final ScaleRange DIST = new ScaleRange("scale1.png", 141, 0) {
		public java.awt.Color getColor(double value) {
			return super.getColor(Math.sqrt(Math.abs(value)));
		};
	};

	public static final ScaleRange DETECTABLE = new ScaleRange("scale1.png", 0, 3) {
		public java.awt.Color getColor(double value) {
			return super.getColor(value>1?1+Math.log10(Math.abs(value)):value);
		};
	};

	public static final ScaleRange SPECTRO = new ScaleRange("scale2.png", 0, 1000);
